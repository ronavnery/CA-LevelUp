  ...
  <section @click="goToDetails" class="offer-preview">
    ...
    <main>
      ...
      <div class="user-date-starred-container">
        <div class="wrapper">
          <img :src="offer.createdBy.img" alt />
        ...
        <svg
          ...
          viewBox="-1 -1 108.99999999999991 109.04511627906979"
          width="25"
          height="25"
        >
          <defs>
  ...
  data() {
    return {
      offer: {
        ...
        imgs: ["https://picsum.photos/334/290", "https://picsum.photos/300"],
        tags: ["Photography", "Music", "Dancing"],
        requirements: ["Positive Attitude"],
        category: "Personal Development",
        stars: 1.0,
        createdBy: {
          _id: "5d288a710c7055b551d4a9d1",
          name: "Harding Holden",
          img: "https://picsum.photos/id/1005/50",
          phone: "059-284-3326"
        },
